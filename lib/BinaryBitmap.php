...
final class BinaryBitmap{
	 ...
	 */
	public function crop(int $left, int $top, int $width, int $height):BinaryBitmap{
	...
	/**
	 * @return bool Whether this bitmap supports counter-clockwise rotation.
	 */
	 ...
	 *
	 * @return \Zxing\BinaryBitmap A rotated version of this object.
	 */
