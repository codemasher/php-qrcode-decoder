...
final class Decoder{
	...
	public function decode($variable, array $hints = null):DecoderResult{
		...
		throw new Exception('decode error Decoder.php');
	}
	 ...
	 * @param array $hints  decoding hints that should be used to influence decoding
	 *
	 * @return DecoderResult text and bytes encoded within the QR Code
	 * @throws FormatException if the QR Code cannot be decoded
	 * @throws ChecksumException if error correction fails
	 */
	public function decodeImage(array $image, array $hints = null):DecoderResult{
	 ...
	 * @throws ChecksumException if error correction fails
	 */
	public function decodeBits(BitMatrix $bits, array $hints = null):DecoderResult{
