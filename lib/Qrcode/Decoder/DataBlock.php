...
final class DataBlock{
	...
	private array $codewords; //byte[]

	private function __construct(int $numDataCodewords, array $codewords){
	 ...
	 * @param \Zxing\Qrcode\Decoder\Version              $version      version of the QR Code
	 * @param \Zxing\Qrcode\Decoder\ErrorCorrectionLevel $ecLevel      error-correction level of the QR Code
	 *
	 ...
	 */
	public static function getDataBlocks(array $rawCodewords, Version $version, ErrorCorrectionLevel $ecLevel):array{
		...
		/** @var \Zxing\Qrcode\Decoder\ECB $ecBlock */
