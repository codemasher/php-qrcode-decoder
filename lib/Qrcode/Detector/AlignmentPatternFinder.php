...
final class AlignmentPatternFinder{
	...
	/** @var \Zxing\Qrcode\Detector\AlignmentPattern[] */
	 ...
	 *
	 * @param \Zxing\Common\BitMatrix $image      image to search
	 ...
	 *
	 * @return \Zxing\Qrcode\Detector\AlignmentPattern if found
	 ...
	 *
	 * @return \Zxing\Qrcode\Detector\AlignmentPattern|null if we have found the same pattern twice, or null if not
	 */
