...
class Detector{
	 ...
	 *
	 * @param array|null hints optional hints to detector
	 *
	 * @return {@link DetectorResult} encapsulating results of detecting a QR Code
	 * @throws NotFoundException if QR Code cannot be found
	 * @throws FormatException if a QR Code cannot be decoded
	 */
	public final function detect(array $hints = null):DetectorResult{/*Map<DecodeHintType,?>*/
		...
		$transform = self::createTransform($topLeft, $topRight, $bottomLeft, $dimension, $alignmentPattern);

		$sampler = new GridSampler;

		$bits = $sampler->sampleGrid_($this->image, $dimension, $dimension, $transform);
	 ...
	 *
	 * @param \Zxing\Qrcode\Detector\FinderPattern $topLeft    detected top-left finder pattern center
	 * @param \Zxing\Qrcode\Detector\FinderPattern $topRight   detected top-right finder pattern center
	 * @param \Zxing\Qrcode\Detector\FinderPattern $bottomLeft detected bottom-left finder pattern center
	 *
	 * @return float estimated module size
	 */
	protected final function calculateModuleSize(FinderPattern $topLeft, FinderPattern $topRight, FinderPattern $bottomLeft):float{
		// Take the average
		return (
